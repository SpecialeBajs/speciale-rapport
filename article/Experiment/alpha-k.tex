...
\begin{table*}[]
    \begin{tabular}{|l|l|l|l|}
        ...
        Weighted sum       & 0.03237            & \underline{0.1064} &             \\ \hline
        $\mathbf{e}^{(0)}$ & 0.02169            & 0.08177            & 0.03669     \\ \hline
        $\mathbf{e}^{(1)}$ & 0.02523            & 0.1019             & 0.0458      \\ \hline
        $\mathbf{e}^{(2)}$ & 0.03419            & \textbf{0.1086}    &             \\ \hline
        $\mathbf{e}^{(3)}$ & 0.03483            & 0.09956            & 0.0372      \\ \hline
        $\mathbf{e}^{(4)}$ & \underline{0.0366} & 0.08863            &             \\ \hline
