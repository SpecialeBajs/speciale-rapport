...
\begin{table*}[]
    \begin{tabular}{|l|l|l|l|}
        ...
        Weighted sum       & 0.03255           & 0.1064   &             \\ \hline
        $\mathbf{e}^{(0)}$ & 0.02241           & 0.08177  &             \\ \hline
        $\mathbf{e}^{(1)}$ & 0.02563           & 0.1019   &             \\ \hline
        $\mathbf{e}^{(2)}$ & 0.03419           & 0.1086   &             \\ \hline
        $\mathbf{e}^{(3)}$ & 0.03449           & 0.09956  &             \\ \hline
        $\mathbf{e}^{(4)}$ &                   &          &             \\ \hline
        $\mathbf{e}^{(5)}$ &                   &          &             \\ \hline
    \end{tabular}
    \centering
