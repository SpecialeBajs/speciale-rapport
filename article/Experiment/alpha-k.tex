...
In this section we discuss the results from the experiments on only utilizing one layer and removing the 0th embedding that where described in \autoref{sec:method:alpha-k-effect}.
