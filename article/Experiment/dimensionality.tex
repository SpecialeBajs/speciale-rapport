...
In both of these datasets nodes have above 19 connections in average and therefore the nodes gain knowledge much faster about the graph than in amazon-cell-sport.
