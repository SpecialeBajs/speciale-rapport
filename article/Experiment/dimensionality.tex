...
All of the results for LightGCN with different layers with NDCG and Recall can be found in Appendix \ref{app:average-lightgcn-results}.
...
\todo{Beskriv videre når vi har resultaterne.}
