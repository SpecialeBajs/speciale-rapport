...
These splits can be seen in Appendix \autoref{app:adjusted-layer-combi} on \autoref{tab:ALC-degree-based-ndcg} and \autoref{tab:BLC-degree-based-ndcg}.
As can be observed Yelp2020 declines 1 \% in performance from 0.2177 to 0.21553.
Amazon-Book decline in performance, \todo{insert results here}
Amazon-Cell-Sport increases 10\% in performance from 0.06451 to 0.07117.
