...
In both of these datasets nodes have above 19 connections in average and therefore the amount of collaborative signals increase much faster for each node in the graph compared to amazon-cell-sport.
