...
Generally it can be observed that there is different performance improvements depending on the dataset.
...
For Yelp2020 there is a small improvement of 1.15 \% on NDCG and 0.68 \% in Recall.
For Amazon-Book there is a decrease in performance by -2.36 \% and an improvement on 0.78 \% for recall.
