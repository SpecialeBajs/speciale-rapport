...
In this experiment we used the results from \autoref{subsec:degree-experiment} and calculate the layer effects with \autoref{fredsplit} only on the overall performance in each layer, and not depending on the node degree.
