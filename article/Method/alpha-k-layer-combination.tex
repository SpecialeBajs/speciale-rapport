...
Before trying to optimize $\alpha_k$ we wanted to investigate how large the impact of it is.
A simple experiment to see the impact of $\alpha_k$ is by simply removing it.
