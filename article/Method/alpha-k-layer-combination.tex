...
After the experiments done on node degree [ref her tak] it was decided to make an algorithm that chose the layers' effect based on how they perform compared to each other.
...
\\
The basic idea of this algorithm is to look at the performance of the individual layers, then based on how many percent worse they performe compared to the best layer they will get a penalty in their effect and the other layers will get an increase.
...
Meanwhile the 15 is split evenly among the other 3 layers who now have a effect of 30\%.
