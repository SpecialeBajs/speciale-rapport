...
This is something that LightGCN took advantage of and simplified NGCF by removing the activation function and the transformation matrix, which showed promising results in their experiments.
...
BiTGCF and GCF removes different parts of NGCF, which was inspired by LightGCN, but chooses to keep different aspect of NGCF.
