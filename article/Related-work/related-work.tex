...
In our paper, we use a simplified version of a Neural Graph Collaborative Filtering(NGCF) that is a method that uses GCN's for collaborative filtering \cite{lightgcn, NGCF}.
