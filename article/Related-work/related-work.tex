...
In our paper, we use a simplified version of a graph convolutional network(GCN) called LightGCN \cite{lightgcn}.
As mentioned earlier LightGCN simplified NGCF's implementation of a GCN \cite{lightgcn, NGCF}.
