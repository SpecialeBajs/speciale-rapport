\section{One layer node degrees performance}\label{app:degree-experiment}\label{app:individual-recall-degree-experiment}
This section contains the recall results conducted in \autoref{subsec:degree-experiment}.
%Yelp2020 Recall
\begin{table*}[h!]
    \centering
...
\section{Average LightGCN results}\label{app:average-lightgcn-results}
This section shows the performance of LightGCN on Yelp2020, Amazon-Book and Amazon-Cell-Sport with one to five convolutions and node degree evaluated.
This was conducted to gain and understanding of how well the different node degrees performs with the LightGCN layer combination.
\begin{table*}[]
    \centering
