...
The core difference between NGCF and LightGCN is that LightGCN does not utilize weights and an activation function \cite{lightgcn,NGCF_2019}.
Our intuition behind adding weights would be that this could learn the layer combination required, as there are weight matrices for each layers.
